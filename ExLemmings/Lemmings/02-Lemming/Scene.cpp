...
void Scene::update(int deltaTime)
{
	...
	/*if (deathbybomb == 1) {
		startbombing = currentTime;
		//Continuar igual fins durant 5 segons, llavors parar lemmings, canviar animacions i generar particules
		if (currentTime - startbombing > 5000) {
